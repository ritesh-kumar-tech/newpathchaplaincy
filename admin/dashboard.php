...
<section class="metric-grid">
  <div class="metric"><span>Total members</span><strong><?php echo h($metrics['members']); ?></strong></div>
  <div class="metric"><span>Pending applications</span><strong><?php echo h($metrics['pending_members']); ?></strong></div>
